"""
SilentEye ML — Trainer  (FINAL v11)
=====================================
FIXES v11:
  - train_one(): _get_feature_names(category) — was hardcoded "image"
    causing video/SVG top features to display image feature names
    (models were correct, only display was wrong)
  - train_from_dirs(): passes correct category to train_one()
  - evaluate_from_dirs(): added for test.py eval command
  - Multi-source directory support from v10 kept
"""
