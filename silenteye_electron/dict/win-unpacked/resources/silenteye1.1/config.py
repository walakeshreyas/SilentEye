...
AUDIO_LSB_MIN_FILE_BYTES   = 100000           # FIXED: was 500KB — too high, small WAV files missed
                                               # 100KB = ~0.6 sec mono 44100Hz → enough for LSB analysis
AUDIO_LSB_MIN_SAMPLES      = 5000             # FIXED: was 10000 — lowered to catch smaller WAV files
AUDIO_LSB_MAX_SAMPLES      = 100000           # Cap samples for performance
AUDIO_LSB_RATIO_LOW        = 0.490            # LSB ratio range for stego detection (slightly wider)
AUDIO_LSB_RATIO_HIGH       = 0.510
AUDIO_LSB_CHI_SQ_THRESHOLD = 3.0             # FIXED: was 1.5 — too strict, missed true random LSBs
                                               # True random (os.urandom) chi_sq ≈ 0.0-2.5
                                               # 3.0 catches uniform LSB while avoiding natural audio
...
# FIXED: was duplicated in both files causing silent divergence
# ============================================================
...
# Layers that unambiguously confirm malware — bypass scoring entirely
# REMOVED: pdf_exploit_signatures, doc_exploit_signatures
#   "cmd.exe in PDF" → 95 malicious was firing on pentest reports
#   These now go through weighted scoring at score=90 instead
